...
module.exports = async function (fastify, opts) {
  fastify.get('/restaurant', async function (request, reply) {//get
  ...
  fastify.post('/menu', async function (request, reply) {//post
  ...
  fastify.patch('/restaurant', async function (request, reply) {//patch
  ...
  //내일작성하기
  fastify.delete('/menu/:id', async function (request, reply) {
